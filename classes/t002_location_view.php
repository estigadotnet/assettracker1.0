 ...
 * Page class
 */
class t002_location_view extends t002_location
{
	...
	// Page object name
	public $PageObjName = "t002_location_view";
	...
	public function run()
	{
		...
		if (!$this->setupApiRequest()) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t002_locationlist.php"));
				else
		...
		if (!$Security->canView()) {
			...
			$this->terminate("t002_locationlist.php");
			return;
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t002_locationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t002_locationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t002_locationlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t002_locationlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
