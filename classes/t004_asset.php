...
class t004_asset extends DbTable
{
	...
	public function __construct()
	{
		...
		// Asset
		$this->Asset = new DbField('t004_asset', 't004_asset', 'x_Asset', 'Asset', '`Asset`', '`Asset`', 200, 255, -1, FALSE, '`Asset`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Asset->setDbValue($rs->fields('Asset'));
