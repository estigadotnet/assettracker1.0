...
class t004_asset_search extends t004_asset
{
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->Asset); // Asset
	...
	protected function loadSearchValues()
	{
		...
		if ($this->signature_id->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Asset->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->Asset->Raw)
				$this->Asset->AdvancedSearch->SearchValue = HtmlDecode($this->Asset->AdvancedSearch->SearchValue);
			$this->Asset->EditValue = HtmlEncode($this->Asset->AdvancedSearch->SearchValue);
