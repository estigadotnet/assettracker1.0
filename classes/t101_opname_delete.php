 ...
 * Page class
 */
class t101_opname_delete extends t101_opname
{
	...
	// Page object name
	public $PageObjName = "t101_opname_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_opnamelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t101_opnamelist.php"); // Return to list
			}
		}
	}
