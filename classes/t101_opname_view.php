 ...
 * Page class
 */
class t101_opname_view extends t101_opname
{
	...
	// Page object name
	public $PageObjName = "t101_opname_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t101_opnamelist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t101_opnamelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t101_opnamelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t101_opnamelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t101_opnamelist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
