...
class t102_ho_detail_list extends t102_ho_detail
{
	...
	protected function clearInlineMode()
	{
		...
		$this->proc_ccost->FormValue = ""; // Clear form value
		$this->dep_amount->FormValue = ""; // Clear form value
		$this->dep_ytd->FormValue = ""; // Clear form value
		$this->nb_val->FormValue = ""; // Clear form value
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_asset_id") && $CurrentForm->hasValue("o_asset_id") && $this->asset_id->CurrentValue != $this->asset_id->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_proc_date") && $CurrentForm->hasValue("o_proc_date") && $this->proc_date->CurrentValue != $this->proc_date->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_proc_ccost") && $CurrentForm->hasValue("o_proc_ccost") && $this->proc_ccost->CurrentValue != $this->proc_ccost->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_dep_amount") && $CurrentForm->hasValue("o_dep_amount") && $this->dep_amount->CurrentValue != $this->dep_amount->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_dep_ytd") && $CurrentForm->hasValue("o_dep_ytd") && $this->dep_ytd->CurrentValue != $this->dep_ytd->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_nb_val") && $CurrentForm->hasValue("o_nb_val") && $this->nb_val->CurrentValue != $this->nb_val->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->hohead_id->AdvancedSearch->toJson(), ","); // Field hohead_id
		$filterList = Concat($filterList, $this->asset_id->AdvancedSearch->toJson(), ","); // Field asset_id
		$filterList = Concat($filterList, $this->proc_date->AdvancedSearch->toJson(), ","); // Field proc_date
		$filterList = Concat($filterList, $this->proc_ccost->AdvancedSearch->toJson(), ","); // Field proc_ccost
		$filterList = Concat($filterList, $this->dep_amount->AdvancedSearch->toJson(), ","); // Field dep_amount
		$filterList = Concat($filterList, $this->dep_ytd->AdvancedSearch->toJson(), ","); // Field dep_ytd
		$filterList = Concat($filterList, $this->nb_val->AdvancedSearch->toJson(), ","); // Field nb_val
	...
	protected function restoreFilterList()
	{
		...
		// Field hohead_id
		$this->hohead_id->AdvancedSearch->SearchValue = @$filter["x_hohead_id"];
		$this->hohead_id->AdvancedSearch->SearchOperator = @$filter["z_hohead_id"];
		$this->hohead_id->AdvancedSearch->SearchCondition = @$filter["v_hohead_id"];
		$this->hohead_id->AdvancedSearch->SearchValue2 = @$filter["y_hohead_id"];
		$this->hohead_id->AdvancedSearch->SearchOperator2 = @$filter["w_hohead_id"];
		$this->hohead_id->AdvancedSearch->save();
		...
		// Field proc_date
		$this->proc_date->AdvancedSearch->SearchValue = @$filter["x_proc_date"];
		$this->proc_date->AdvancedSearch->SearchOperator = @$filter["z_proc_date"];
		$this->proc_date->AdvancedSearch->SearchCondition = @$filter["v_proc_date"];
		$this->proc_date->AdvancedSearch->SearchValue2 = @$filter["y_proc_date"];
		$this->proc_date->AdvancedSearch->SearchOperator2 = @$filter["w_proc_date"];
		$this->proc_date->AdvancedSearch->save();

		// Field proc_ccost
		$this->proc_ccost->AdvancedSearch->SearchValue = @$filter["x_proc_ccost"];
		$this->proc_ccost->AdvancedSearch->SearchOperator = @$filter["z_proc_ccost"];
		$this->proc_ccost->AdvancedSearch->SearchCondition = @$filter["v_proc_ccost"];
		$this->proc_ccost->AdvancedSearch->SearchValue2 = @$filter["y_proc_ccost"];
		$this->proc_ccost->AdvancedSearch->SearchOperator2 = @$filter["w_proc_ccost"];
		$this->proc_ccost->AdvancedSearch->save();

		// Field dep_amount
		$this->dep_amount->AdvancedSearch->SearchValue = @$filter["x_dep_amount"];
		$this->dep_amount->AdvancedSearch->SearchOperator = @$filter["z_dep_amount"];
		$this->dep_amount->AdvancedSearch->SearchCondition = @$filter["v_dep_amount"];
		$this->dep_amount->AdvancedSearch->SearchValue2 = @$filter["y_dep_amount"];
		$this->dep_amount->AdvancedSearch->SearchOperator2 = @$filter["w_dep_amount"];
		$this->dep_amount->AdvancedSearch->save();

		// Field dep_ytd
		$this->dep_ytd->AdvancedSearch->SearchValue = @$filter["x_dep_ytd"];
		$this->dep_ytd->AdvancedSearch->SearchOperator = @$filter["z_dep_ytd"];
		$this->dep_ytd->AdvancedSearch->SearchCondition = @$filter["v_dep_ytd"];
		$this->dep_ytd->AdvancedSearch->SearchValue2 = @$filter["y_dep_ytd"];
		$this->dep_ytd->AdvancedSearch->SearchOperator2 = @$filter["w_dep_ytd"];
		$this->dep_ytd->AdvancedSearch->save();

		// Field nb_val
		$this->nb_val->AdvancedSearch->SearchValue = @$filter["x_nb_val"];
		$this->nb_val->AdvancedSearch->SearchOperator = @$filter["z_nb_val"];
		$this->nb_val->AdvancedSearch->SearchCondition = @$filter["v_nb_val"];
		$this->nb_val->AdvancedSearch->SearchValue2 = @$filter["y_nb_val"];
		$this->nb_val->AdvancedSearch->SearchOperator2 = @$filter["w_nb_val"];
		$this->nb_val->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		if (!$Security->canSearch())
			return "";
		$this->buildSearchSql($where, $this->hohead_id, $default, FALSE); // hohead_id
		$this->buildSearchSql($where, $this->asset_id, $default, FALSE); // asset_id
		$this->buildSearchSql($where, $this->proc_date, $default, FALSE); // proc_date
		$this->buildSearchSql($where, $this->proc_ccost, $default, FALSE); // proc_ccost
		$this->buildSearchSql($where, $this->dep_amount, $default, FALSE); // dep_amount
		$this->buildSearchSql($where, $this->dep_ytd, $default, FALSE); // dep_ytd
		$this->buildSearchSql($where, $this->nb_val, $default, FALSE); // nb_val
		...
		if (!$default && $this->Command == "search") {
			$this->hohead_id->AdvancedSearch->save(); // hohead_id
			$this->asset_id->AdvancedSearch->save(); // asset_id
			$this->proc_date->AdvancedSearch->save(); // proc_date
			$this->proc_ccost->AdvancedSearch->save(); // proc_ccost
			$this->dep_amount->AdvancedSearch->save(); // dep_amount
			$this->dep_ytd->AdvancedSearch->save(); // dep_ytd
			$this->nb_val->AdvancedSearch->save(); // nb_val
	...
	{
		if ($this->hohead_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->asset_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->proc_date->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->proc_ccost->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->dep_amount->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->dep_ytd->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->nb_val->AdvancedSearch->issetSession())
			return TRUE;
	...
	{
		$this->hohead_id->AdvancedSearch->unsetSession();
		$this->asset_id->AdvancedSearch->unsetSession();
		$this->proc_date->AdvancedSearch->unsetSession();
		$this->proc_ccost->AdvancedSearch->unsetSession();
		$this->dep_amount->AdvancedSearch->unsetSession();
		$this->dep_ytd->AdvancedSearch->unsetSession();
		$this->nb_val->AdvancedSearch->unsetSession();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->proc_date, $ctrl); // proc_date
			$this->updateSort($this->proc_ccost, $ctrl); // proc_ccost
			$this->updateSort($this->dep_amount, $ctrl); // dep_amount
			$this->updateSort($this->dep_ytd, $ctrl); // dep_ytd
			$this->updateSort($this->nb_val, $ctrl); // nb_val
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->proc_date->setSort("");
				$this->proc_ccost->setSort("");
				$this->dep_amount->setSort("");
				$this->dep_ytd->setSort("");
				$this->nb_val->setSort("");
			}
	...
	protected function loadDefaultValues()
	{
		...
		$this->proc_ccost->OldValue = $this->proc_ccost->CurrentValue;
		$this->dep_amount->CurrentValue = 0.00;
		$this->dep_amount->OldValue = $this->dep_amount->CurrentValue;
		$this->dep_ytd->CurrentValue = 0.00;
		$this->dep_ytd->OldValue = $this->dep_ytd->CurrentValue;
		$this->nb_val->CurrentValue = 0.00;
		$this->nb_val->OldValue = $this->nb_val->CurrentValue;
	...
	protected function loadSearchValues()
	{
		...
		// hohead_id
		if (!$this->isAddOrEdit() && $this->hohead_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->hohead_id->AdvancedSearch->SearchValue != "" || $this->hohead_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// proc_date
		if (!$this->isAddOrEdit() && $this->proc_date->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->proc_date->AdvancedSearch->SearchValue != "" || $this->proc_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// proc_ccost
		if (!$this->isAddOrEdit() && $this->proc_ccost->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->proc_ccost->AdvancedSearch->SearchValue != "" || $this->proc_ccost->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// dep_amount
		if (!$this->isAddOrEdit() && $this->dep_amount->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->dep_amount->AdvancedSearch->SearchValue != "" || $this->dep_amount->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// dep_ytd
		if (!$this->isAddOrEdit() && $this->dep_ytd->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->dep_ytd->AdvancedSearch->SearchValue != "" || $this->dep_ytd->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// nb_val
		if (!$this->isAddOrEdit() && $this->nb_val->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->nb_val->AdvancedSearch->SearchValue != "" || $this->nb_val->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_proc_date"))
			$this->proc_date->setOldValue($CurrentForm->getValue("o_proc_date"));
		...
		if ($CurrentForm->hasValue("o_proc_ccost"))
			$this->proc_ccost->setOldValue($CurrentForm->getValue("o_proc_ccost"));
		...
		if ($CurrentForm->hasValue("o_dep_amount"))
			$this->dep_amount->setOldValue($CurrentForm->getValue("o_dep_amount"));
		...
		if ($CurrentForm->hasValue("o_dep_ytd"))
			$this->dep_ytd->setOldValue($CurrentForm->getValue("o_dep_ytd"));
		...
		if ($CurrentForm->hasValue("o_nb_val"))
			$this->nb_val->setOldValue($CurrentForm->getValue("o_nb_val"));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (strval($this->proc_ccost->EditValue) != "" && is_numeric($this->proc_ccost->EditValue)) {
				...
				$this->proc_ccost->OldValue = $this->proc_ccost->EditValue;
			}
			...
			if (strval($this->dep_amount->EditValue) != "" && is_numeric($this->dep_amount->EditValue)) {
				...
				$this->dep_amount->OldValue = $this->dep_amount->EditValue;
			}
			...
			if (strval($this->dep_ytd->EditValue) != "" && is_numeric($this->dep_ytd->EditValue)) {
				...
				$this->dep_ytd->OldValue = $this->dep_ytd->EditValue;
			}
			...
			if (strval($this->nb_val->EditValue) != "" && is_numeric($this->nb_val->EditValue)) {
				...
				$this->nb_val->OldValue = $this->nb_val->EditValue;
			}
	...
	public function getRowHash(&$rs)
	{
		if (!$rs)
			return "";
		$hash = "";
		$hash .= GetFieldHash($rs->fields('hohead_id')); // hohead_id
		$hash .= GetFieldHash($rs->fields('asset_id')); // asset_id
		$hash .= GetFieldHash($rs->fields('proc_date')); // proc_date
		$hash .= GetFieldHash($rs->fields('proc_ccost')); // proc_ccost
		$hash .= GetFieldHash($rs->fields('dep_amount')); // dep_amount
		$hash .= GetFieldHash($rs->fields('dep_ytd')); // dep_ytd
		$hash .= GetFieldHash($rs->fields('nb_val')); // nb_val
		return md5($hash);
	}
